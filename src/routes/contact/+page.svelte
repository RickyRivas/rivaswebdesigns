  ...
  <div class="form-container">
    ...
    <div class="contact-items">
      ...
      <div class="item">
        ...
        <div class="socials">
          <a
            href="https://www.facebook.com/profile.php?id=100091290063493"
            class="icon fb"
            target="_blank"
            ><svg
              width="25"
            ...
            <span class="screenreader">Follow us on Facebook</span></a>
          <a href="https://www.instagram.com/ink_bros_custom_apparel/" class="icon" target="_blank"
            ><svg
              ...
              ><path
                ...
                fill="currentcolor" /></svg>
            <span class="screenreader">Follow us on Instagram</span></a>
        </div>
      </div>
    </div>
    <form
