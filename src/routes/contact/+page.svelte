...
<svelte:head>
  ...
  <meta name="twitter:data2" content="" /> -->
	<title>{companyName} | {thisPage?.name} | {cityAndState}</title>
</svelte:head>
...
<section id="contact-landing">
	<div class="form-container">
		<h2>Get in touch.</h2>
		<p>
			Let us know if you have any questions or would like to talk about a potential project. We respond to every call or
			email we get!
		</p>
		<div class="contact-items">
			...
			<div class="item">
				<span>Follow Us</span>
				<div class="socials">
					<a href="https://www.facebook.com/profile.php?id=100091290063493" class="icon fb" target="_blank">
						<svg
							width="25"
							height="25"
							viewBox="0 0 25 25"
							...
							role="img">
							<path
								d="M14.4361 25V13.5972H18.262L18.836 9.15195H14.4361V6.31434C14.4361 5.02775 14.7919 4.15095 16.639 4.15095L18.9909 4.14999V0.174037C18.5842 0.121182 17.188 0 15.563 0C12.1698 0 9.84668 2.07121 9.84668 5.87409V9.15195H6.00916V13.5972H9.84668V25H14.4361Z"
								fill="currentcolor" />
						</svg>
						<span class="screenreader">Follow us on Facebook</span>
					</a>
					<a href="https://www.instagram.com/ink_bros_custom_apparel/" class="icon" target="_blank">
						<svg
							width="26"
							height="25"
							viewBox="0 0 26 25"
		...
		<form id="contact-form" method="post" name="contact" netlify="true" enctype="multipart/form-data">
			...
			<div class="form-control">
				...
				<input id="phone-input" type="number" name="number" placeholder="+1 (918) 000-0000" required="" />
			</div>
			<div class="form-control">
				<label for="referral-input">How did you hear about us?</label>
				<input id="referral-input" type="text" name="Referral" placeholder="Facebook, Referral, Google" required="" />
			</div>
			<div class="form-control">
	...
	<img class="side-stock" src="/contactside.jpg" alt="clothes" width="648" height="800" loading="lazy" decoding="async" />
</section>
